...
(function($){
    ...
    $(document).ready(function(){
        ...
        $('.wpdf-repeater').each(function(){
            ...
            if(repeater_templates[_template_name] == undefined){
                repeater_templates[_template_name] = _repeater.find('.wpdf-repeater__template').clone().show().removeClass('wpdf-repeater__template').wrap('<div>');
            }
    ...
    $(document).on('click', '.wpdf-add-row', function(e){
        ...
        _repeater.append(repeater_templates[_template_name].clone());
        ...
        _repeater.find('.wpdf-repeater-row').each(function(elIndex){
            $(this).find('input[name], select[name]').each(function () {
                var name;
                name = $(this).attr('name');
                name = name.replace(/\[[0-9]*\]$/g, '[' + elIndex + ']');
                $(this).attr('name', name);
            });
        });
    });
    ...
    $(document).on('click', '.wpdf-del-row', function(e){
        ...
        if(_repeater.find('.wpdf-repeater-row').length > 1) {
