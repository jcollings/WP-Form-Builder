		...
		<div class="wpdf-cols">
			...
			<div class="wpdf-right">
				<div class="wpdf-right__inside">
					...
					<div class="wpdf-panel">
						<div class="wpdf-panel__header">
							<a href="<?php echo remove_query_arg('setting'); ?>" class="wpdf-panel__title">General</a>
						</div>
					</div>
					...
					if ( ! empty( $modules ) ) {
						foreach( $modules as $module_id => $module ) {
							if(method_exists($module,'display_settings')){
								...
								<div class="wpdf-panel">
									<div class="wpdf-panel__header">
										<a href="<?php echo add_query_arg( 'setting', $module_id ); ?>" class="wpdf-panel__title"><?php echo $module->get_name(); ?></a>
									</div>
								</div>
								<?php
							}
